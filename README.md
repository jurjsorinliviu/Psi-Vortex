...
The repository contains 21 experiments spanning the original validation suite (16) and three follow-up sets: architecture selection (2), statistical robustness (20-seed), and BIC runtime analysis.
